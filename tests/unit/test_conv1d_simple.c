/*
 * test_conv1d_simple.c — Tests Conv1D corrigés et simplifiés
 */
...
static int test_conv1d_causality_simple() {
    printf("Testing Conv1D simple causality...\n");
...
int main() {
    printf("=== Conv1D Simple Test Suite ===\n");
    ...
    total++; passed += test_conv1d_causality_simple();
